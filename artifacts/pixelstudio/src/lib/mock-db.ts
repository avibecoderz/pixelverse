...
let staffDB: Staff[] = [
  { id: 's1', name: 'Ngozi Adeyemi', email: 'ngozi@pixelstudio.ng', phone: '08031234567', status: 'Active', dateAdded: '2023-11-01T10:00:00Z' },
  { id: 's2', name: 'Emeka Okafor', email: 'emeka@pixelstudio.ng', phone: '08059876543', status: 'Active', dateAdded: '2023-11-15T10:00:00Z' },
  { id: 's3', name: 'Aisha Bello', email: 'aisha@pixelstudio.ng', phone: '08167001122', status: 'Inactive', dateAdded: '2023-12-05T10:00:00Z' },
  { id: 's4', name: 'Tunde Adeleke', email: 'tunde@pixelstudio.ng', phone: '07089994455', status: 'Active', dateAdded: '2024-01-10T10:00:00Z' },
];
